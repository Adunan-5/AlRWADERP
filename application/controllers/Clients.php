    ...
    public function company()
    {
        if ($this->input->post() && is_primary_contact()) {
            ...
            if ($this->form_validation->run() !== false) {
                ...
                $data['name_arabic'] = $this->input->post('name_arabic');
                $data['building'] = $this->input->post('building');
                $data['building_arabic'] = $this->input->post('building_arabic');
                $data['street'] = $this->input->post('street');
                $data['street_arabic'] = $this->input->post('street_arabic');
                $data['district'] = $this->input->post('district');
                $data['district_arabic'] = $this->input->post('district_arabic');
                $data['city']        = $this->input->post('city');
                $data['city_arabic'] = $this->input->post('city_arabic');
                $data['state']       = $this->input->post('state');
                $data['state_arabic'] = $this->input->post('state_arabic');
                $data['zip']         = $this->input->post('zip');
                $data['postal_code_arabic'] = $this->input->post('postal_code_arabic');
                $data['postal_code_additional'] = $this->input->post('postal_code_additional');
                $data['postal_code_additional_arabic'] = $this->input->post('postal_code_additional_arabic');
                $data['country']     = $this->input->post('country');
                $data['cr_number'] = $this->input->post('cr_number');
                $data['client_contact_person'] = $this->input->post('client_contact_person');
