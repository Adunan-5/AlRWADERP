            ...
            <div role="tabpanel"
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?= render_input('name', 'client_name', isset($client) ? $client->name : '', 'text', ['id' => 'name_en']); ?>
                            </div>
                            <div class="col-md-6">
                                <?= render_input('name_arabic', 'client_name_arabic', isset($client) ? $client->name_arabic : '', 'text', ['id' => 'name_ar']); ?>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6">
                                <?= render_input('building', 'building_name', isset($client) ? $client->building : '', 'text', ['id' => 'building_name_en']); ?>
                            </div>
                            <div class="col-md-6">
                                <?= render_input('building_arabic', 'building_name_arabic', isset($client) ? $client->building_arabic : '', 'text', ['id' => 'building_name_ar']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <?= render_input('street', 'street_name', isset($client) ? $client->street : '', 'text', ['id' => 'street_name_en']); ?>
                            </div>
                            <div class="col-md-6">
                                <?= render_input('street_arabic', 'street_name_arabic', isset($client) ? $client->street_arabic : '', 'text', ['id' => 'street_name_ar']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <?= render_input('district', 'district_name', isset($client) ? $client->district : '', 'text', ['id' => 'district_name_en']); ?>
                            </div>
                            <div class="col-md-6">
                                <?= render_input('district_arabic', 'district_name_arabic', isset($client) ? $client->district_arabic : '', 'text', ['id' => 'district_name_ar']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <?= render_input('city_arabic', 'city_name_arabic', isset($client) ? $client->city_arabic : '', 'text', ['id' => 'city_name_ar']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <?= render_input('state_arabic', 'state_name_arabic', isset($client) ? $client->state_arabic : '', 'text', ['id' => 'state_name_ar']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <?php $value = (isset($client) ? $client->zip : ''); ?>
                                <?= render_input('zip', 'postal_code', $value); ?>
                            </div>
                            <div class="col-md-6">
                                <?= render_input('postal_code_arabic', 'postal_code_arabic', isset($client) ? $client->postal_code_arabic : '', 'text', ['id' => 'postal_code_ar']); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <?= render_input('postal_code_additional', 'postal_code_additional', isset($client) ? $client->postal_code_additional : '', 'text', ['id' => 'postal_code_additional_en']); ?>
                            </div>
                            <div class="col-md-6">
                                <?= render_input('postal_code_additional_arabic', 'postal_code_additional_arabic', isset($client) ? $client->postal_code_additional_arabic : '', 'text', ['id' => 'postal_code_additional_ar']); ?>
                            </div>
                        </div>
                        ...
                        <?php if (get_option('company_requires_vat_number_field') == 1) {
                         ...
                         <?= render_input('cr_number', 'client_cr_number', isset($client) ? $client->cr_number : '', 'text', ['id' => 'client_cr_number']); ?>
                         <?= render_input('client_contact_person', 'client_contact_person', isset($client) ? $client->client_contact_person : '', 'text', ['id' => 'client_contact_person']); ?>
                        ...
                        <?= render_input('client_email', 'client_email', isset($client) ? $client->client_email : '', 'text', ['id' => 'client_email']); ?>
                        <div style="display: none;">
                        <?php if ((isset($client) && empty($client->website)) || ! isset($client)) {
                            $value = (isset($client) ? $client->website : '');
                            echo render_input('website', '', $value, '', ['style' => 'display:none;']);
                        } else { ?>
