...
$_table_data                         = [
    ...
    [
        'name'     => _l('client_display_name_table'),
    ...
    // [
    //     'name'     => _l('client_name_arabic'),
    //     'th_attrs' => ['class' => 'toggleable', 'id' => 'th-name-arabic'],
    // ],
    // [
    ...
    [
        'name'     => _l('projects'),
        'th_attrs' => ['class' => 'toggleable', 'id' => 'th-projects'],
    ],
    [
