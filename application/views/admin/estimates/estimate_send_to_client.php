				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							// --- Fetch client info ---
							$client = $this->clients_model->get($estimate->clientid);

							// --- Render single email input (instead of contact selector) ---
							echo render_input('send_to_email', 'invoice_estimate_sent_to_email', $client->client_email, '', ['type' => 'email', 'required' => true]);
							// $selected = [];
