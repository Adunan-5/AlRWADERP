...
<div id="wrapper">
    ...
    <div class="modal fade" id="add_file" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                <div class="row">
                <div class="col-md-6">
                    <?= render_input('document_type', 'Document Type') ?>
                </div>
                <div class="col-md-6">
    ...
    <script>
        ...
        $(function() {
            ...
            $('body').on('click', '.edit-file', function(e) {
                ...
                $.post(admin_url + 'staff/get_file/' + id, function(response) {
                    ...
                    $('#file-form input[name="document_type"]').val(data.document_type);
        ...
        $(document).on('click', '#pay-form button[type="submit"]', function() {
