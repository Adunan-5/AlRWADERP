...
class Clients_model extends App_Model
{
    ...
    public function get($id = '', $where = [])
    {
     ...
     ', name, name_arabic, building, building_arabic, street, street_arabic, district, district_arabic, city_arabic, state_arabic, postal_code_arabic, postal_code_additional,
    postal_code_additional_arabic, cr_number, client_contact_person, client_email');
    ...
    public function add($data, $withContact = false)
    {
        ...
        $data['name_arabic']  = isset($data['name_arabic']) ? $data['name_arabic'] : null;
        $data['building']         = isset($data['building']) ? $data['building'] : null;
        $data['building_arabic']  = isset($data['building_arabic']) ? $data['building_arabic'] : null;
        $data['street']         = isset($data['street']) ? $data['street'] : null;
        $data['street_arabic']  = isset($data['street_arabic']) ? $data['street_arabic'] : null;
        $data['district']         = isset($data['district']) ? $data['district'] : null;
        $data['district_arabic']  = isset($data['district_arabic']) ? $data['district_arabic'] : null;
        $data['city_arabic']  = isset($data['city_arabic']) ? $data['city_arabic'] : null;
        $data['state_arabic']  = isset($data['state_arabic']) ? $data['state_arabic'] : null;
        $data['postal_code_arabic']  = isset($data['postal_code_arabic']) ? $data['postal_code_arabic'] : null;
        $data['postal_code_additional']         = isset($data['postal_code_additional']) ? $data['postal_code_additional'] : null;
        $data['postal_code_additional_arabic']  = isset($data['postal_code_additional_arabic']) ? $data['postal_code_additional_arabic'] : null;
        $data['cr_number']         = isset($data['cr_number']) ? $data['cr_number'] : null;
        $data['client_contact_person']  = isset($data['client_contact_person']) ? $data['client_contact_person'] : null;
        $data['client_email']         = isset($data['client_email']) ? $data['client_email'] : null;
