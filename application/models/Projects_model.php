...
class Projects_model extends App_Model
{
    ...
    {
        if ($with_name) {
            $this->db->select(db_prefix() . 'staff.firstname,' . db_prefix() . 'staff.lastname,' . db_prefix() . 'staff.email,' . db_prefix() . 'project_members.project_id,' . db_prefix() . 'project_members.staff_id');
        } else {
            $this->db->select(db_prefix() . 'staff.email,' . db_prefix() . 'project_members.project_id,' . db_prefix() . 'project_members.staff_id');
        }
