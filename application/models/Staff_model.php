...
class Staff_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        if (isset($data['joining_date_hijri']) && empty($data['joining_date_hijri'])) {
    ...
    class Skills_model extends App_Model
    {
        ...
        public function add($data)
        {
            $this->db->insert($this->table, ['name' => trim($data['name'])]);
    ...
    class Staff_type_model extends App_Model
    {
    ...
    class Own_employee_type_model extends App_Model
    {
        protected $table = 'tblownemployeetype';
