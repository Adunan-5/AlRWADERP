...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (staff_can('view', 'staff')) {
        // Make Staff a collapsible parent menu
        ...
        $CI->app_menu->add_sidebar_children_item('staff', [
            'slug'     => 'document-types-menu',
            'name'     => _l('document_types'),
            'href'     => admin_url('document_types'),
            'position' => 50,
        ]);

        $CI->app_menu->add_sidebar_children_item('staff', [
            'slug'     => 'allowance-types-menu',
            'name'     => _l('allowance_types'),
