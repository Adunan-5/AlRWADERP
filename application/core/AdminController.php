...
class AdminController extends App_Controller
{
    ...
    private function init_quick_actions_links()
    {
        ...
        // ✅ Supplier (custom module/controller)
        $this->app->add_quick_actions_link([
            'name'       => _l('supplier'),
            'url'        => 'suppliers/add', // adjust to your actual controller/method
            'permission' => 'suppliers', // create permission group in your module if needed
            'position'   => 20,
            'icon'       => 'fa-solid fa-truck', // pick icon you like
        ]);
    }
}