...
function _app_init()
{
    ...
    hooks()->add_action('app_admin_footer', function(){
        echo '<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.blockUI/2.70/jquery.blockUI.min.js"></script>';
        echo '<script src="' . base_url('assets/js/zee-custom.js') . '"></script>';
    });
}
