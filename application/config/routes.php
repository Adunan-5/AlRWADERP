...
$route['admin/timesheet/upload_pdf'] = 'admin/timesheet/upload_pdf';
$route['timesheet/upload_excel'] = 'admin/timesheet/upload_excel';

$route['admin/staff_timesheet/get_grids/(:num)'] = 'admin/staff_timesheet/get_grids/$1';
$route['admin/staff_timesheet/get_details/(:num)'] = 'admin/staff_timesheet/get_details/$1';
$route['admin/staff_timesheet/save_timesheet'] = 'admin/staff_timesheet/save_timesheet';